...
<body>
  <div class="box">
    <div class="">
      <h2>BAC PRO T.U</h2>
      <h3 id="st">(Technicien d'Usinage)</h3>
    </div>
    ...
    <div class="elements">
      ...
      <p style="margin-top:20px;">Le technicien d’usinage dessine les pièces et prépare les programmes de conception et de fabrication de celles-ci à l’aide de logiciels spécifiques.

        Il devra maîtriser plusieurs compétences allant du réglage des machines à commandes numériques au contrôle qualité. Toutes les pièces sont fabriquées à l’aide d’outils de haute technologie.

      </p>
      <ul style="margin-top:20px;">
        <li>Sur des logiciels de DAO (Dessin Assisté par Ordinateur) et de FAO (Fabrication Assistée par Ordinateur)</li>
        <li>Sur des tours à commande numérique</li>
        <li>Sur des centres d’usinages</li>
        <li>Sur du matériel de contrôle MMT (Machine à Mesurer Tridimensionnelle…)</li>
      </ul>
      <p>L’objectif est de former des techniciens hautement qualifiés dans le domaine de la production en maîtrisant les techniques d’usinage informatisées.</p>
    </div>
    <div class="elements">
